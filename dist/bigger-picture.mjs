...
/* src/components/image.svelte generated by Svelte v4.2.19 */
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(div1, "wheel", /*onWheel*/ ctx[15], { passive: true }),
...
/* src/components/iframe.svelte generated by Svelte v4.2.19 */
...
/* src/components/video.svelte generated by Svelte v4.2.19 */
...
/* src/bigger-picture.svelte generated by Svelte v4.2.19 */
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			attr(button0, "class", "bp-base bp-x");
			attr(button0, "title", "Close");
			attr(button0, "aria-label", "Close");
			attr(button1, "class", "bp-base bp-ext");
			attr(button1, "title", "Open Fullsize");
			attr(button1, "aria-label", "Open Fullsize");
			attr(button2, "class", "bp-base bp-save");
			attr(button2, "title", "Save");
			attr(button2, "aria-label", "Save");
